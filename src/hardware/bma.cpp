...
//   config.input_en  = BMA4_INPUT_DISABLE;
    ...
    // sensor.setINTPinConfig(config, BMA4_INTR2_MAP);
    ...
    // sensor.enableActivityInterrupt(true);
    // sensor.enableFeature(BMA423_ANY_MOTION, true);
    // sensor.enableAnyNoMotionInterrupt(true);
...
{
    esp_sleep_enable_ext0_wakeup((gpio_num_t)ACC_INT_1_PIN,
                                 0); // enable deep sleep wake on RTC interrupt
    esp_sleep_enable_ext0_wakeup((gpio_num_t)ACC_INT_2_PIN,
                                 0); // enable deep sleep wake on RTC interrupt
}
uint32_t getSteps()
{
